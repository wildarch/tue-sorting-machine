...
\input{"Machine Design/MachineDesign.tex"}

\chapter {Software specification}
\input{"Software Specification/SoftwareSpecification.tex"} 

\chapter{Software design}
\input{"Software Design/software design.tex"}

\chapter{Software implementation}
\input{"Software Implementation/software implementation.tex"}

\chapter{System validation and testing}
\input{"Testing _ Validating/V2 System Validation _ Testing.tex"}
